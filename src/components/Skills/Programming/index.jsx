                ...
                <div className="skills__group">
                    {/* <div className="skills__data">
                        ...
                        <div>
                            ...
                            <span className="skills__level"><i className='bx bxl-html5' style={{ color: '#E7461E' }}></i></span>
                        </div>
                    </div>
                    <div className="skills__data">
                        <i className="bx bx-badge-check"></i>
                        <div>
                            ...
                            <span className="skills__level"><i className='bx bxl-css3' style={{ color: '#27A8E3' }}></i></span>
                        </div>
                    </div> */}
                    <div className="skills__data">
                        <i className="bx bx-badge-check"></i>
